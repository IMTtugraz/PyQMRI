...
#    XT = np.zeros([c+1,z,y,x],dtype=np.complex64)   #5,128,128
    ...
    for i in range(0, n):
        ...
        XT = apweightsns(W, XN, fft, img_shape)
...
#        print(RES.shape)  4,128,128
        ...
        # calculate rhs
        (r_img, r) = derHns(W, image_T, XT, RES, realConstr, fft,
                            img_shape, ksp_shape)
        ...
        for j in range(0, 128):
            ...
            (tmpim, tmpc) = derHns(
                W, image_T, XT, derns(
                    W, image_T, XT, d_img, d, fft, ksp_shape, img_shape),
                realConstr, fft, img_shape, ksp_shape)
