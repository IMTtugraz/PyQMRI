...
par.fa_corr = np.require(np.flip(np.transpose(par.fa_corr,(0,2,1)),1),requirements='C')
################################################################################
...
#
#
#queue1 = cl.CommandQueue(ctx, platforms[1].get_devices()[0], properties=cl.command_queue_properties.OUT_OF_ORDER_EXEC_MODE_ENABLE)
#queue2 = cl.CommandQueue(ctx, platforms[1].get_devices()[0], properties=cl.command_queue_properties.OUT_OF_ORDER_EXEC_MODE_ENABLE)
#
