...
def gen_default_config():
    ...
    config['DEFAULT'] = {}
    config['DEFAULT']["max_iters"] = '1000'
    config['DEFAULT']["start_iters"] = '100'
    config['DEFAULT']["max_gn_it"] = '6'
    config['DEFAULT']["lambd"] = '1e6'
    config['DEFAULT']["gamma"] = '1e3'
    config['DEFAULT']["delta"] = '1e-2'
    config['DEFAULT']["omega"] = '0'
    config['DEFAULT']["display_iterations"] = '1'
    config['DEFAULT']["gamma_min"] = '3e2'
    config['DEFAULT']["delta_max"] = '1e-1'
    config['DEFAULT']["omega_min"] = '0'
    config['DEFAULT']["tol"] = '1e-10'
    config['DEFAULT']["stag"] = '1e10'
    config['DEFAULT']["delta_inc"] = '10'
    config['DEFAULT']["gamma_dec"] = '0.5'
    config['DEFAULT']["omega_dec"] = '0.5'

    config['3D_TGV'] = {}
    config['3D_TGV']["max_iters"] = '1000'
    config['3D_TGV']["start_iters"] = '100'
    config['3D_TGV']["max_gn_it"] = '6'
    config['3D_TGV']["lambd"] = '1e6'
    config['3D_TGV']["gamma"] = '1e3'
    config['3D_TGV']["delta"] = '1e-2'
    config['3D_TGV']["omega"] = '0'
    config['3D_TGV']["display_iterations"] = '1'
    config['3D_TGV']["gamma_min"] = '3e2'
    config['3D_TGV']["delta_max"] = '1e-1'
    config['3D_TGV']["omega_min"] = '0'
    config['3D_TGV']["tol"] = '1e-10'
    config['3D_TGV']["stag"] = '1e10'
    config['3D_TGV']["delta_inc"] = '10'
    config['3D_TGV']["gamma_dec"] = '0.5'
    config['3D_TGV']["omega_dec"] = '0.5'

    config['3D_TV'] = {}
    config['3D_TV']["max_iters"] = '1000'
    config['3D_TV']["start_iters"] = '100'
    config['3D_TV']["max_gn_it"] = '6'
    config['3D_TV']["lambd"] = '1e6'
    config['3D_TV']["gamma"] = '1e3'
    config['3D_TV']["delta"] = '1e-2'
    config['3D_TV']["omega"] = '0'
    config['3D_TV']["display_iterations"] = 'True'
    config['3D_TV']["gamma_min"] = '3e2'
    config['3D_TV']["delta_max"] = '1ee-1'
    config['3D_TV']["tol"] = '1e-10'
    config['3D_TV']["stag"] = '1e10'
    config['3D_TV']["delta_inc"] = '10'
    config['3D_TV']["gamma_dec"] = '0.5'
