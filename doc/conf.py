...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'mbpq.egg-info']
...
man_pages = [
    (master_doc, 'modelbasedparameterquantification', 'Model Based Parameter Quantification Documentation',
     [author], 1)
]
