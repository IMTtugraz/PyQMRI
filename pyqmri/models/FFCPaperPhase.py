...
class Model(BaseModel):
    def __init__(self, par):
        ...
        par["unknowns_TGV"] = 2 + 2*len(self.b)
        par["unknowns_H1"] = 0
        ...
        for j in range(self.numT1Scale):
            self.constraints.append(
                constraints(5,
                            2000,
                            True))
        for j in range(self.numT1Scale+1):
            self.constraints.append(
                constraints(0,
                            10,
                            False))
    ...
    def _execute_forward_3D(self, x):
        ...
        S[:len(t)] = (
            x[0] * self.uk_scale[0]
            * x[-1-self.numT1Scale] * self.uk_scale[-1-self.numT1Scale]
    ...
    def plot_unknowns(self, x, dim_2D=False):
        ...
        tmp_x[-self.numT1Scale-1:] = np.abs(tmp_x[-self.numT1Scale-1:])
        tmp_x = np.real(tmp_x)
