...
#    self.mask = par["file"]["image_mask"][()]
        ...
        self.M0 = 0.2 * 1.3085805 * \
            np.ones((self.NSlice, self.dimY, self.dimX), dtype=DTYPE) * self.mask
...
#    self.constraints.append(constraints(1e-4/self.uk_scale[9],3/self.uk_scale[9],True))
    ...
    def _execute_gradient_3D(self, x):
        ...
        grad_M0 = self.M0 * \
            self.uk_scale[0] * (-E1 + 1) * self.sin_phi / (-E1 * self.cos_phi + 1)
...
#        t53 = A_G[ind]*t52
    ...
    def _set_init_scales(self, dscale):
        ...
        test_M0 = np.ones((self.NSlice, self.dimY, self.dimX),
                          dtype=DTYPE)  # *0.9785314
        ...
        Te = 1 * np.ones((self.NSlice, self.dimY, self.dimX),
